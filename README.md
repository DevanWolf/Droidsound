...
**WRITE_EXTERNAL_STORAGE (mandatory)**<br>To access internal and external SD cards for music.

**RECORD_AUDIO (optional)**<br>To enable visualizer. Not required for playback.

**WRITE_SETTINGS (optional)**<br>To save ringtones.

**POST_NOTIFICATIONS (optional)**<br>To show notifications.